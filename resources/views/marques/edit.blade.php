...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><img src="{{asset('imgs/modifier.png')}}" alt="Erreur Image" width="20" height="20">{{ __(" - Marque : ".$type->type) }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('marques.update',$marque) }}">
                        @csrf
                        @method('put')
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="marque" type="text" class="form-control @error('marque') is-invalid @enderror" name="marque" value="{{ $marque->marque }}" required autocomplete="marque" autofocus>

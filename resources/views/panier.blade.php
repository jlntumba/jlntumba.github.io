                                                                        ...
                                                                        <tr>
                                                                            <td align="center">
                                                                                <div  class="position-absolute">
                                                                                    <form action="{{ route('deletePanierMac',$panier[$i]->article_id) }}" accept-charset="UTF-8" method="post">
                                                                                        @csrf
                                                                                        @method('delete')
                                                                                    ...
                                                                                    <table class="table table-bordered table-sm table-primary">
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                ...
                                                                                                <td>
                                                                                                    <button class="btn btn-success"  id="buy{{ $i }}" onclick="return alert('Si cet article a déjà été payé avec le numéro que vous allez entrer, la quantité augmentera, le nom et adresse seront modifiés ! ')" data-articleID="{{ $panier[$i]->article()[0]->id }}" data-articleMode="{{ $panier[$i]->mode_id }}" data-articleTaille="{{ $panier[$i]->taille_id }}" data-articleCouleur="{{ $panier[$i]->couleur_id }}" {{ $panier[$i]->article()[0]->nbr<$panier[$i]->qte ? 'disabled' : ''  }}>
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        <table class="table table-bordered table-sm table-primary">
                                                                                            ...
                                                                                            <tbody>
                                                                                                @foreach (AchatMac::where('mac',$mac->mac)->where('article_id',$achete->article_id)->get() as $a)
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            {{ $a->noms }}
                                                                                                        </td>
                                                                    ...
                                                                    <td>
                                                                        <table class="table table-striped table-sm">
                                                                            <tr>
                                                                                <td align="center">
                                                                                    <div  class="position-absolute">
                                                                                        <form action="{{ route('deleteLivraison',$recu->article_id) }}" accept-charset="UTF-8" method="post">
                                                                                            @csrf
                                                                                            @method('delete')
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        <table class="table table-bordered table-sm table-primary">
                                                                                            ...
                                                                                            <tbody>
                                                                                                @foreach (LivraisonMac::where('mac',$mac->mac)->where('article_id',$recu->article_id)->get() as $r)
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            {{ $r->noms }}
                                                                                                        </td>
        ...
        <div class="modal-content modal-dialog-centered" style="text-decoration-color: white">
            ...
            <div class="modal-body" id="body">
                <form action=""  id="validePaiement" method="get">
                    ...
                    <input id="noms" type="text" class="form-control @error('noms') is-invalid @enderror" name="noms" value="{{ old('noms') }}" required autocomplete="noms" autofocus placeholder="Nom complet...">
                    <input id="tel" type="tel" class="form-control @error('tel') is-invalid @enderror" name="tel" value="{{ old('tel') }}" required autocomplete="tel" autofocus placeholder="Numéro de téléphone...">
                    <textarea name="addrs" id="addrs" class="form-control @error('addrs') is-invalid @enderror" cols="30" rows="5" placeholder="adresse..." required></textarea><br>
            ...
            $(document).ready(function(){
                ...
                for (let z = 0; z < panierQte; z++) {
                    ...
                    $('#buy'+z).on("click",function(){
                        ...
                        $('#validePaiement').attr("action","{{ route('paiementMac') }}");
